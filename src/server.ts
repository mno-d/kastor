...
import { registerShellTool } from "./register-shell-tool.js";
...
import { contentLineCount, countDiffStats, newFilePatch } from "./server-diff-utils.js";
import {
...
function createMcpServer(
  ...
  registerShellTool(server, config, toolNames, workspaces);
